const projectList = {
  projects: [
    ...
    {
      id: 'nordy',
      title: 'Nordy Portrait',
      description: 'Take your picture and turn it into an illustrated Nordy Portrait for The Nordy Club, Nordstrom\'s new customer loyalty program.. We made this website at Resn. I mainly worked on all the animations and the mobile WebGL.',
      date: '<a href="http://resn.co.nz/" target="_blank">Resn</a> 2018',
      link: 'View website',
      url: 'https://nordyportrait.nordstrom.com/',
      role: '<div>Creative Developer</div>',
      technologies: '<div>WebGL</div><div>ThreeJS</div>',
      clients: '<div>Nordy Club </div>',
      awards: '<div><a href="https://www.awwwards.com/sites/nordy-portrait" target="_blank">Awwwards - SOTD</a></div><div><a href="https://thefwa.com/cases/nordy-portrait" target="_blank">FWA - SOTD</a></div>',
      medias: [
    ...
    {
      id: 'olouen',
      title: 'Olivier Ouendeno',
      description: 'Portfolio of digital art director Olivier Ouendeno.',
      date: '2019',
      link: 'View website',
      url: 'http://olouen.com/',
      role: '<div>Creative Developer</div>',
      technologies: '<div>WebGL</div><div>ThreeJS</div>',
      clients: '<div>Olivier Ouendeno</div>',
      awards: '<div><a href="https://www.awwwards.com/sites/olivier-ouendeno-portfolio" target="_blank">Awwwards - SOTD</a></div><div><a href="https://thefwa.com/cases/olivier-ouendeno-p2" target="_blank">FWA - SOTD</a></div>',
      medias: [
